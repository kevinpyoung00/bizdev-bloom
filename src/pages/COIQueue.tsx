            ...
            {bc ? (
              <div className="border border-border rounded-lg p-3">
                ...
                <div className="flex gap-3 mt-2">
                  ...
                  {bc.linkedin_url && <a href={bc.linkedin_url} target="_blank" rel="noopener noreferrer" className="text-xs text-primary flex items-center gap-1"><Linkedin size={12} /> LinkedIn</a>}
                </div>
              </div>
            ) : (
